...
import windIcon from '../assets/windi.png';
import humidityIcon from '../assets/humidity.png';
import visibilityIcon from '../assets/visibility.png';
import sunriseIcon from '../assets/sunrisee.png';
import sunsetIcon from '../assets/sunsett.png';
...
export const SunsetIcon=() => <Icon src={sunsetIcon} alt="S unset" className='powerful-pulse svg-hover'/>